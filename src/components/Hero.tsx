        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -bottom-8 -left-8 p-6 bg-white rounded-lg shadow-xl max-w-[220px] border-2 border-smart-mint/30"
            >
            ...
            <motion.div 
              ...
              className="absolute -top-8 -right-8 p-6 bg-white rounded-lg shadow-xl max-w-[220px] border-2 border-smart-blue/30"
            >
              <div className="flex items-center mb-3">
